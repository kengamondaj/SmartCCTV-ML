...
def pool2d(tensor, type= 'max'):
    ...
    print(sz)
    if type == 'max':
        x = torch.nn.functional.max_pool2d(tensor, kernel_size=(1, 4))
    # if type == 'mean':
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load("./log/market1501/alignedreid/checkpoint_ep300.pth.tar", encoding='latin1')
    ...
    img_path1 = './data/ake (1).jpg'
    img_path2 = './data/keng.jpg'
